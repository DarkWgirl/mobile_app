...
if($check_exist > 0 && $fetchAid['liked_status'] === "1"){
    ...
    $updadate = mysqli_query($pos_db, "UPDATE sentiment_tbl set liked_status = '0' where sentiment_id = '$sentId'");
    
}else{

    $insert_sentiments = mysqli_query($pos_db, "INSERT INTO sentiment_tbl (student_id, article_id, liked_status) VALUES ('$sid', '$aid', '0')");
