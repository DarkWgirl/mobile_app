...
$scope.getCompanyDetails = function(){
  $http({
method: 'get',
url: 'php_script/dc_assistant/retrieve_company_for_project.php'
...
$scope.getProject = function(){
 $http({
  method: 'get',
  url: 'php_script/dc_assistant/retrieve_project_for_employee.php'
...
$scope.getTicket = function(){
 $http({
  method: 'get',
  url: 'php_script/dc_assistant/dc_ticket_view.php',
...
$scope.submitRecall = function(new_recall){
  $http({
    method: 'POST',
    url: 'php_script/dc_assistant/recall_ticket.php',
    data: new_recall
  }).success(function(){
      $scope.getTicket();
  $scope.closeRecall1();
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_implemented.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/implemented_filter.php'
}).success(function(data){
$scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_implemented_button.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_confirmed.php'
}).success(function(notif){
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/confirmed_filter.php'
}).success(function(data){
$scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_confirmed_button.php'
...
$scope.getOngoingTicket = function(ticket){
 $http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/ongoing_filter.php',
 }).success(function(data) {
  // Store response data
  $scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_ongoing_button.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_ongoing.php'
}).success(function(notif){
...
$scope.getTicketLive = function(search){
 $http({
  method: 'POST',
  url: 'php_script/dc_assistant/approver_live_view.php',
  data: search
 }).success(function(data) {
  // Store response data
  $scope.ticket_table = data;
...
$scope.soloResolutions = function(ticket){
 ...
 $http({
  method: 'get',
  url: 'php_script/dc_assistant/solo_reso.php'
 }).success(function(data) {
  // Store response data
...
$scope.getUserTicket = function(){
 $http({
  method: 'get',
  url: 'php_script/dc_assistant/customer_ticket.php'
 }).success(function(data) {
  // Store response data
...
$scope.InsertDeclinedRemarks = function(new_declined_ticket){
    $http({
method: 'POST',
url: 'php_script/dc_assistant/declined_ticket.php',
...
$('#declined_ticket').modal('hide');
    ...
    $http({
method: 'POST',
url: 'php_script/dc_assistant/email/email_requestor_rejected.php',
data: new_declined_ticket
  });
...
$scope.viewResolutionsTable = function(ticket){
  ...
  angular.copy(ticket, reso_form);
    $http({
method: 'POST',
url: 'php_script/dc_assistant/read_resolution_table.php',
data: reso_form
  }).success(function(data){
...
$scope.FormError = "Plese input atleast 6 characters";
  ...
  $http({
method: 'POST',
url: 'php_script/dc_assistant/change_password.php',
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/pending_filter.php'
}).success(function(data){
$scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/for_implementation_filter.php'
}).success(function(data){
$scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_for_implementation.php'
}).success(function(notif){
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_fimple_button.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/filters/declined_filter.php'
}).success(function(data){
$scope.ticket_table = data;
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_declined_button.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/show_filter_pending_button.php'
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_pending.php'
}).success(function(notif){
...
$http({
  method: 'get',
  url: 'php_script/dc_assistant/notif_declined.php'
}).success(function(notif){
...
$scope.InsertApproveRemarks = function(new_approval_form){
    $http({
method: 'POST',
url: 'php_script/dc_assistant/approve_ticket.php',
...
$('#approval_modal').modal('hide');
      ...
      $scope.getTicket();
          ...
          $http({
method: 'POST',
url: 'php_script/dc_assistant/email/to_dc_head.php',
data: new_approval_form
  });
};
...
$scope.InsertRemarks = function(new_ticket_form){
    $http({
method: 'POST',
url: 'php_script/dc_assistant/create_remarks.php',
